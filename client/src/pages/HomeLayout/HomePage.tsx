...
const HomePage = () => {
        ...
        <div className='bg-white'>
            <div className='relative isolate px-6 pt-14 lg:px-8'>
                ...
                <div className='mx-auto max-w-2xl pb-36 pt-24 sm:pb-48 sm:pt-36 lg:pb-40 lg:pt-32'>
                    <div>
                        <img src={Logo} alt='logo' className='mx-auto opacity-70' />
                    </div>
    ...
    // return (
    //     <main classNameName='grid min-h-screen place-content-center bg-background text-foreground'>
    //         <h1 classNameName='justify-self-center text-center text-2xl font-medium md:text-4xl'>Welcome to PixelBug!</h1>
